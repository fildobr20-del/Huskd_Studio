        ...
        <div className="glass-gold rounded-2xl p-8">
          ...
          <div className="mb-6 rounded-xl bg-blue-500/10 border border-blue-500/20 p-4">
            ...
            <div className="flex gap-3">
              <a href="https://t.me/usernamesks" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#2AABEE]/20 border border-[#2AABEE]/30 py-2.5 text-sm font-medium text-[#2AABEE] hover:bg-[#2AABEE]/30 transition">
              ...
              <a href="https://wa.me/79531817113" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#25D366]/20 border border-[#25D366]/30 py-2.5 text-sm font-medium text-[#25D366] hover:bg-[#25D366]/30 transition">
